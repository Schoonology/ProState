...
// TODO
function _extend(childFn, parentFn, states) {
  util.inherits(childFn, parentFn)

  console.log(childFn.prototype.states, childFn.prototype.states.Start.begin.toString())

  childFn.prototype.states = _.extend(
    Object.create(parentFn.prototype.states),
    states,
    childFn.prototype.states
  )

  console.log(childFn.prototype.states, childFn.prototype.states.Start.begin.toString())

  childFn.extend = function extend(grandchildFn, states) {
    return _extend(grandchildFn, childFn, states)
  }
...
Actor.extend = extend
function extend(childFn, states) {
  return _extend(childFn, Actor, states)
}
